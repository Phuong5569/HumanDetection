...
RPICAM_CAMERA_COUNT = int(env_choice("RPICAM_CAMERA_COUNT", "1", ("1", "2")))
RPICAM_LEFT_EXTRA_ARGS = env("RPICAM_LEFT_EXTRA_ARGS", "--camera 0")
RPICAM_RIGHT_EXTRA_ARGS = env("RPICAM_RIGHT_EXTRA_ARGS", "--camera 1")
